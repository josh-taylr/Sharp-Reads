...
package dev.josh.taylor.sharpreads.test
 ...
 * ```
 * @get:Rule
 * var mainCoroutineRule = dev.josh.taylor.sharpreads.test.MainCoroutineRule()
 * ```
 *
 ...
 * mainCoroutineRule.dev.josh.taylor.sharpreads.test.runBlocking { }
 * ```
 */
